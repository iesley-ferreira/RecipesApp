const drinkRecipeData = {
  ...
  strInstructions: `Pour the Galliano liqueur over ice. Fill the 
  remainder of the glass with ginger ale and thats all there is to 
  it. You now have a your very own GG.`,
  strInstructionsES: null,
  strInstructionsDE: `Den Galliano-Likör über Eis gießen. Füllen 
  Sie den Rest des Glases mit Ginger Ale und das ist alles, was 
  dazu gehört. Du hast jetzt ein eigenes GG.`,
...
const mealRecipeData = {
  ...
  strCategory: 'Side',
  strArea: 'Turkish',
  strInstructions: 'Instruções simuladas',
...
export { drinkRecipeData, mealRecipeData };
